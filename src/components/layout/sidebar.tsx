    ...
    <aside className="hidden w-[234px] shrink-0 border-r border-border/70 bg-[#f5f9ff]/85 backdrop-blur lg:flex lg:flex-col">
      <div className="flex h-16 items-center border-b border-border/70 px-4">
        <Link href="/" className="flex items-center gap-2">
          <span className="flex h-7 w-7 items-center justify-center rounded bg-gradient-to-br from-[#0f355b] to-[#1d6bb8] text-[10px] font-semibold text-white shadow-sm">
            FX
          </span>
          <span className="text-sm font-semibold text-[#12395f]">FactCheckX</span>
        </Link>
      </div>
